...
在 Mac 上通过图形化安装器，完成 OpenClaw 的安装、验证与模型配置，无需命令行基础即可使用。

*[English version](README-MAC-EN.md)*
...
从以下任一渠道获取 **macOS 安装包**（DMG），双击打开后将「OpenClaw 安装器」拖入「应用程序」即可。
...
更多说明见 [更新 OpenClaw 与配置](docs/UPDATING-OPENCLAW-AND-CONFIG.md)。
